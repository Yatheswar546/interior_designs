...
<body>
   ...
   <div class="main-content">
    ...
    <div class="container">
        <h2>Feedback</h2>
        <!-- <a class="btn btn-primary button" href="/gallery/create.php" role="button">New Client</a> -->
        <br> 
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <!-- <tr>
                    ...
                    <td>rishi@gmail</td>
                    <td>5+698742120</td>
                    <td>I want a full size sofa of comfy style</td>
                    <td>25-09-1892</td>
                    <td>
                ...
                <td>3</td>
                    ...
                    <td>acutha@gmail</td>
                    <td>+1237637890</td>
                    <td>I need a teddy bear chair model.</td>
                    <td>26-09-1892</td>
                    <td>
                        <a class='btn btn-primary btn-sm space' href='./edit.php?id=$row[id]'>Edit</a><br>
                        <a class='btn btn-danger btn-sm' href='./delete.php?id=$row[id]'>Delete</a>
