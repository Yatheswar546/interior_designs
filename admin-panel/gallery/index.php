   ...
   <div class="main-content">
    ...
    <main>
        <div class="container">
            ...
            <a class="btn btn-primary button" href="./create.php" role="button">New Image</a>
            <br> 
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>$row[name]</td>
                                <td>$row[size]</td>
                                <td><img src='./db_images/$row[image]' width=20px; height=20px;></td>
                    ...
                    <!-- <tr>
                        ...
                        <td>5*5</td>
                        <td>Image</td>
                        <td>This item is trending right now.</td>
                        <td>13-03-2022</td>
                        <td>
