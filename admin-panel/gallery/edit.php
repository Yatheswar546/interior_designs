...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    do{
        if(empty($id) || empty($name) || empty($size) || empty($file) || empty($discription)){
            $errorMessage = "All the fields are required";
            break;
        }
        $sql = "UPDATE `gallery` 
        SET `name`='$name',`size`='$size',`image`='$file',`discription`='$discription'
        WHERE id = $id";
    ...
    <div class="container my-5">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="discription" id="discription" value="<?php echo $discription; ?>">
                </div>
            </div>
            <!-- <div class="row mb-3">
